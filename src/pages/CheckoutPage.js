                ...
                <div>
                  <ul role="list">
                    {address.map((person) => (
                      <li
                        key={person.email}
                        className="flex justify-between px-5 gap-x-6 py-5 border-solid border-2 border-grey-200"
                      >
